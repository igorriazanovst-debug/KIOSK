...
import NavigationRuntime from '../components/NavigationRuntime';
...
// ──────────────────────────────────────────────────────────────────────────
  const renderWidget = (widget: Widget) => {
    ...
    // Navigation виджет — runtime (шаг 5)
    if (widget.type === 'navigation') {
      return (
        <div key={widget.id} data-widget-id={widget.id} style={{ ...commonStyle, overflow: 'hidden' }}>
          <NavigationRuntime
