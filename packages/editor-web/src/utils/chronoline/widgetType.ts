// packages/editor-web/src/utils/chronoline/widgetType.ts
...
// В editor-web настраивается только внешний вид/поведение виджета и,
// опционально, стартовый контент, который копируется на устройство при первом
// запуске.
