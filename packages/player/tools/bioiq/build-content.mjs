// packages/player/tools/bioiq/build-content.mjs
//
...
//
// Запуск: node tools/bioiq/build-content.mjs
...
const OUT = path.join(HERE, '..', '..', 'src', 'bioiq', 'content', 'bioiqRealContent.json');
...
const DEMO_OUT = path.join(HERE, '..', '..', 'src', 'bioiq', 'content', 'bioiqDemoContent.json');
