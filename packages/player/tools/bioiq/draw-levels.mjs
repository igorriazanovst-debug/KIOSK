// packages/player/tools/bioiq/draw-levels.mjs
//
...
//
// Запуск: node tools/bioiq/draw-levels.mjs [каталог вывода]
...
// «БиоIQ» — ровно одно изображение на уровень (quiz.images[level]).
...
console.log('\nкоординаты: tools/bioiq/structures.json');
