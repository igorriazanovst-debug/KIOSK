...
function q(overrides: Partial<PhysastroiqQuestion> = {}): PhysastroiqQuestion {
  return {
    id: 'q1', text: 't', answer: 'a', helpText: '', x: 0, y: 0, width: PHYSASTROIQ_DEFAULT_POINT_SIZE, height: PHYSASTROIQ_DEFAULT_POINT_SIZE, decoyPoints: [],
...
function point(overrides: Partial<PhysastroiqPoint> = {}): PhysastroiqPoint {
  return { x: 0, y: 0, width: PHYSASTROIQ_DEFAULT_POINT_SIZE, height: PHYSASTROIQ_DEFAULT_POINT_SIZE, ...overrides };
}
