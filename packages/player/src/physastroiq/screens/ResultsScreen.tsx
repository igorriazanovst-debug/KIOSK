// packages/player/src/physastroiq/screens/ResultsScreen.tsx
import React, { useState } from 'react';
import type { PhysastroiqAnswerEvent } from '../gameLogic.ts';
...
interface Props {
  playerNames: string[];
  answers: PhysastroiqAnswerEvent[];
            ...
            {playerAnswers.map((a, i) => (
              ...
              >
                {playerQuestions[i]?.answerImage && (
                  <img
                    src={physastroiqItemImageUrl(playerQuestions[i].answerImage as string)}
                    alt=""
