    ...
    <div className="natcom-runtime">
      <header className="natcom-runtime__bar">
        ...
        {!window.natcomAPI ? (
          ...
          // T5-112 (перф. правка от 2026-09-07): раньше показывали ещё и
          // остальные адреса через «или» - на практике это только путало
          // педагога, если один из них не работал. Показываем только
          // лучший по эвристике (см. VIRTUAL_IFACE_NAME_RE в main.js).
