// packages/player/src/bioiq/screens/ThematicGalleryScreen.tsx
//
// FR-021/FR-022 ТЗ 10 (строки 314-315) — витрина методических тематических
...
const ThematicGalleryScreen: React.FC<Props> = ({ onExit }) => {
  ...
  if (openIndex !== null) {
    const img = BIOIQ_THEMATIC_IMAGES[openIndex];
    return (
      <div className="ciq-page">
        <div className="ciq-page-medium" style={{ textAlign: 'center' }}>
          ...
          <img
            src={bioiqThematicImageUrl(img.fileName)}
            alt={img.title}
    ...
    <div className="ciq-page">
      <div className="ciq-page-medium" style={{ textAlign: 'center' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 16 }}>
          {BIOIQ_THEMATIC_IMAGES.map((img, i) => (
            <button
              key={img.id}
