 ...
 *
 * x/y — ЦЕНТР области, как во всей модели викторины и на игровом поле. Раньше
 * здесь считали от левого верхнего угла: для областей разного размера это
 * давало и ложные наложения, и пропущенные настоящие.
 */
