// packages/player/src/bioiq/editor/QuizCanvas.tsx
...
import { BIOIQ_DEFAULT_POINT_SIZE, type BioiqPoint, type BioiqQuestion } from '../model/schema.ts';
...
interface Props {
  ...
  onAddQuestionPoint: (point: BioiqPoint) => void;
  onAddDecoyToSelected: (point: BioiqPoint) => void;
  onAddGenericDecoy: (point: BioiqPoint) => void;
  onMoveQuestionPoint: (id: string, point: { x: number; y: number }) => void;
  onMoveDecoyOfQuestion: (questionId: string, decoyIndex: number, point: BioiqPoint) => void;
  onMoveGenericDecoy: (index: number, point: BioiqPoint) => void;
...
const QuizCanvas: React.FC<Props> = ({
  ...
  function toStageSpace(point: BioiqPoint): { x: number; y: number } {
  ...
  function handleStageClick(e: Konva.KonvaEventObject<MouseEvent>) {
    ...
    const point = { ...toImageSpace(pointerPosition.x, pointerPosition.y), width: BIOIQ_DEFAULT_POINT_SIZE, height: BIOIQ_DEFAULT_POINT_SIZE };
    if (addMode === 'question') {
