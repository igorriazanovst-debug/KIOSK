// packages/player/src/chimiq/screens/ResultsScreen.tsx
import React, { useState } from 'react';
import type { ChimiqAnswerEvent } from '../gameLogic.ts';
            ...
            {playerAnswers.map((a, i) => (
              ...
              >
                {playerQuestions[i]?.answerImage && (
                  <img
                    src={chimiqItemImageUrl(playerQuestions[i].answerImage as string)}
                    alt=""
