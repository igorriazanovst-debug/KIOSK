// packages/player/src/chimiq/sound.ts
//
...
// ХимIQ (нарисованы программно, не сторонний материал, см.
// docs/chimiq-third-party-licenses.md): звук не добавляет ни одного
