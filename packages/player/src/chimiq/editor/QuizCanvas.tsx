// packages/player/src/chimiq/editor/QuizCanvas.tsx
...
import { CHIMIQ_DEFAULT_POINT_SIZE, type ChimiqPoint, type ChimiqQuestion } from '../model/schema.ts';
...
interface Props {
  ...
  onAddQuestionPoint: (point: ChimiqPoint) => void;
  onAddDecoyToSelected: (point: ChimiqPoint) => void;
  onAddGenericDecoy: (point: ChimiqPoint) => void;
  onMoveQuestionPoint: (id: string, point: { x: number; y: number }) => void;
  onMoveDecoyOfQuestion: (questionId: string, decoyIndex: number, point: ChimiqPoint) => void;
  onMoveGenericDecoy: (index: number, point: ChimiqPoint) => void;
...
const QuizCanvas: React.FC<Props> = ({
  ...
  function toStageSpace(point: ChimiqPoint): { x: number; y: number } {
  ...
  function handleStageClick(e: Konva.KonvaEventObject<MouseEvent>) {
    ...
    const point = { ...toImageSpace(pointerPosition.x, pointerPosition.y), width: CHIMIQ_DEFAULT_POINT_SIZE, height: CHIMIQ_DEFAULT_POINT_SIZE };
    if (addMode === 'question') {
